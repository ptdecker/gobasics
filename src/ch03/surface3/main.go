// Surface3 computes an SVG rendering of an egg carton (of sorts) shaped 3-D surface function.
// It also includes guard code to ignore any polygons whose corner values are infinte or NaN.
