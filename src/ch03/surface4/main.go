// Surface4 computes an SVG rendering of a mogule-shaped 3-D surface function.  It also includes
// guard code to ignore any polygons whose corner values are infinte or NaN.
...
const (
    ...
    zscale  = height * .02         // pixels per z unit
...
func f(x, y float64) float64 {
    return math.Sin(1.5 * x) + 0.5 * math.Cos(math.Sqrt(y))
}
